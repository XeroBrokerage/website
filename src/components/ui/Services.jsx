  ...
  return (
    <div className='font-sans relative p-10 w-full bg-white rounded-2xl flex flex-col gap-4 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-[#e0d6d6]'>
      ...
      <div className='text-center'>
        <h3 className='font-serif font-bold text-2xl text-gray-600 mb-1 tracking-wider'>
          {title}
        </h3>
        <p className='font-light text-sm text-gray-600 px-4 leading-5'>
          {description}
        </p>
      </div>
  ...
  return (
    <div className='py-8 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-7xl mx-auto'>
        <h2 className='text-3xl font-serif font-bold text-center text-gray-600 mb-12'>
          Our Services
        </h2>
