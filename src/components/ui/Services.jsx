...
const ServiceCard = ({ title, description, svgComponent }) => {
  return (
    <div className='font-sans relative p-6 md:p-8 lg:p-10 w-full bg-white rounded-xl md:rounded-2xl flex flex-col gap-3 md:gap-4 shadow-md hover:shadow-lg transition-shadow duration-300 border border-[#e0d6d6]'>
      {/* Service Image */}
      <div className='w-20 h-20 md:w-28 md:h-28 lg:w-36 lg:h-36 bg-gradient-to-br from-[#FFF3F0] to-[#F5EDE0] rounded-full mx-auto flex items-center justify-center shadow-inner'>
      ...
      {/* Decorative Elements */}
      <div className='absolute top-2 right-2 text-[10px] md:text-xs font-serif italic text-[#5C2B29]/50'>
        Service
      </div>
      <div className='absolute bottom-2 left-2 w-6 md:w-8 h-px bg-[#5C2B29]/30'></div>
      <div className='absolute bottom-2 right-2 w-6 md:w-8 h-px bg-[#5C2B29]/30'></div>
    </div>
  )
}
  ...
  return (
    <div className='py-6 md:py-8 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-7xl mx-auto'>
        <h2 className='text-2xl md:text-3xl font-serif font-bold text-center text-gray-800 mb-8 md:mb-12'>
          Our Services
        </h2>
