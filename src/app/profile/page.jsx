      ...
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='bg-white shadow rounded-lg overflow-hidden mb-8'>
          ...
          <div className='bg-blue-400 px-6 py-8 text-center rounded-t-lg flex flex-col items-center'>
            ...
            {/* Contact Me Link - Only show if user.id exists */}
            {user?.id && (
              <div className='mt-4'>
                <Link
                  href={`/contact-owner/${user.id}`}
                ...
                >
                  ...
                  Share My Contact Page
                </Link>
                <p className='text-blue-100 text-sm mt-2'>
                  Share this link for others to contact you
                </p>
              </div>
            )}
          </div>
                ...
                <div className='space-y-4'>
                  ...
                  <div>
                    ...
                    <p className='text-xs text-gray-500 mt-1'>
                      ...
                      {profileData.phone.length === 10 && ' ✓ Valid format'}
                    </p>
                  </div>
                  <div className='flex space-x-3 pt-4'>
                    <button
                      ...
                      disabled={loading || !!validationErrors.phone}
                    >
                      {loading ? (
...
// Working perfectly fine code but without phone number verification
// 'use client'
...
//                 {/* Contact Link Section in View Mode */}
//                 {/* {user?.id && (
...
//                     <div>
//                       <p className='text-sm text-blue-700'>Your Contact Page</p>
//                       <Link
//                         href={`/contact-owner/${user.id}`}
...
//                         Share this link for others to contact you about your
//                         properties
//                       </p>
//                     </div>
//                   </div>
