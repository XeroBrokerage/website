    ...
    return (
      <div className='bg-gray-50 min-h-screen'>
                ...
                <div className='flex items-center mb-4'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-500 text-sm'>
                      {uploadedBy?.email || 'No email provided'}
                    </p>
                  </div>
                </div>
        ...
        <DeletePropertyButton
          ...
          uploaderEmail={uploadedBy?.email}
        />
...
//     description: 'View commercial property listing details',
//   };
// }

// export default async function CommercialPropertyDetails({ params }) {
//   // First access the id directly from params without destructuring
//   const id = params.id;

//   try {
//     await connectDB();
//     const property = await CommercialPropertyModel.findById(id).lean();
...
//                   </div>
//                   <div>
//                     <h3 className="font-medium">{uploadedBy.name}</h3>
//                     <p className="text-gray-500 text-sm">{uploadedBy.email}</p>
//                   </div>
//                 </div>
...
//                   <li className="flex items-center">
//                     <IoIosCheckmarkCircle className="text-yellow-500 mr-2" />
//                     <span>Commercial Type: {propertyType}</span>
//                   </li>
//                   <li className="flex items-center">
//                     <IoIosCheckmarkCircle className="text-yellow-500 mr-2" />
