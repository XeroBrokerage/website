...
const Card = () => {
  return (
    <div className='font-sans relative p-5 w-80 bg-white rounded-2xl flex flex-col gap-4'>
      ...
      <div className='card__img w-40 h-40 bg-gradient-to-r from-[#FFF8F7] to-[#F0F7DF] rounded-full mx-auto'>
        <svg
          xmlnsXlink='http://www.w3.org/1999/xlink'
          xmlns='http://www.w3.org/2000/svg'
          viewBox='0 0 24 24'
          className='h-[150px] transform -rotate-45 translate-x-4'
        >
          <linearGradient
            y2='14.26279'
            y1='7.881249'
          ...
          <path
            opacity='.1'
            d='m8.4998169 10.2068481-5.2928467 5.2930909.5092774.5092773 5.2767658-5.3091717z'
          />
          <path
            opacity='.1'
      ...
      <div className='font-semibold text-2xl text-black'>PINOT NOIR</div>
      <div className='font-normal text-sm text-black tracking-wider'>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
        tempor incididunt.
      </div>
      <div className='flex flex-row justify-between items-center'>
        <div className='font-semibold text-xl text-black'>$16.95</div>
        <div className='flex flex-row items-center gap-4 p-1 bg-[#F7F7F7] rounded-full'>
          <button className='font-bold text-xl text-black w-8 h-8 rounded-full border-none bg-transparent'>
            -
          </button>
          <div className='font-bold text-xl text-black'>2</div>
          <button className='font-bold text-xl text-black w-8 h-8 rounded-full bg-white'>
            +
          </button>
        </div>
      </div>
